...
# tvsd_web/
APPS_DIR: Path = BASE_DIR / "tvsd_web"
env = environ.Env()
...
MIGRATION_MODULES: dict[str, str] = {"sites": "tvsd_web.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "tvsd_web.users.context_processors.allauth_settings",
            ],
        },
    }
]
...
ADMINS = [("""Jasmine Yeung""", "yeungjyy@gmail.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "tvsd_web.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
ACCOUNT_FORMS: dict[str, str] = {"signup": "tvsd_web.users.forms.UserSignupForm"}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "tvsd_web.users.adapters.SocialAccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
SOCIALACCOUNT_FORMS: dict[str, str] = {"signup": "tvsd_web.users.forms.UserSocialSignupForm"}
# django-compressor
# ------------------------------------------------------------------------------
...
SPECTACULAR_SETTINGS = {
    "TITLE": "tvsd-web API",
    "DESCRIPTION": "Documentation of API endpoints of tvsd-web",
    "VERSION": "1.0.0",
    "SERVE_PERMISSIONS": ["rest_framework.permissions.IsAdminUser"],
}
# Vue
# -------------------------------------------------------------------------------
VUE_FRONTEND_USE_DEV_SERVER: bool = DEBUG
